...
class PronounSet {
    /** @constructor */
    constructor(resolver, pronouns = ["they"]) {
     ...
     */
    add(pronoun, failQuietly = this.resolver.config.failQuietly) {
        switch (true) {
     ...
     * Pronouny config.
     */
    use(index = -1, failQuietly = this.resolver.config.failQuietly, useRandom = this.resolver.config.useRandom) {
...
class Pronouny {
    constructor(config = {
        ...
        this.default = {
            ...
            ze2: new Pronoun(// alternate ze/zir set
            {
                subject: ["ze"],
                object: ["zir"],
                possessive: ["zirs"],
        ...
        this.resolveMap = new Map([
            ...
            [defaults.ze.sbj[0], defaults.ze],
            [defaults.ze2.sbj[0], defaults.ze2],
            [defaults.thon.sbj[0], defaults.thon],
            [defaults.ve.sbj[0], defaults.ve],
            [defaults.ne.sbj[0], defaults.ne],
            [defaults.fae.sbj[0], defaults.fae],
            [defaults.xe.sbj[0], defaults.xe],
        ]);
        return this;
    }
    /**# `.resolve()` a Pronoun
     ...
     */
    resolve(pronoun, deepSearch = this.config.deepSearch) {

                ...
                <nav class="list-nav px-2 py-4 w-full">
                    ...
                    <div class="flex gap-2 flex-col">
                        ...
                        <SidebarNavButton href="/settings">
                            ...
                            Settings <span class="badge variant-filled-primary">NEW</span>
                        </SidebarNavButton>
                        {#if $loggedInUser}
                        <div class="h-2"></div>
                        <hr>
                        ...
                        <SidebarNavButton href="/messages" requiresLogin={true}>
                            <svelte:fragment slot="icon">
                        ...
                        <hr>
                        <div class="h-2"></div>
                        <SidebarNavButton href="/teams/members" requiresLogin={true} requiresTeamOwner={true}>
                            <svelte:fragment slot="icon">
                        ...
                        <SidebarNavButton href="/mod/pending" requiresLogin={true} minRole={1}>
                            <svelte:fragment slot="icon">
                        ...
                        <SidebarNavButton href="/teams" requiresLogin={true}>
                            <svelte:fragment slot="icon">
                        ...
                        <SidebarNavButton href="/followed" requiresLogin={true}>
                            <svelte:fragment slot="icon">
                        ...
                        <SidebarNavButton href="/cotw-list" requiresLogin={true} minRole={1}>
                            <svelte:fragment slot="icon">

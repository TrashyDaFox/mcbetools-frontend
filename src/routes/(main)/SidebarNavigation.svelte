<script lang="ts">
    ...
    let notificationsList: any = getContext("notificationsList")
...
<div class="w-full h-full flex flex-col">
    ...
    {#if !$collapsed}
            ...
            <nav class="list-nav px-2 pb-4">
                <ul class="h-full flex flex-col w-full gap-2">
                    <li>
                        <a href="/blog" class={$path == '/blog' ? activeBg : ""}>
                            <span class="badge">
                    ...
                    <li>
                        <a href="/leaderboards" class={$path == '/leaderboards' ? activeBg : ""}>
                            <span class="badge">
                            ...
                            <span class="flex-auto">Leaderboards</span>
                        </a>
                    </li>
                </ul>
            ...
            {#if $loggedInUser}
                ...
                <nav class="list-nav px-2 py-4">
                    <ul class="h-full flex flex-col w-full gap-2">
                        ...
                        <li>
                            <a href="/bookmarks" class={$path == "/bookmarks" ? activeBg : ""}>
                                <span class="badge">
                                ...
                                <span class="flex-auto">My Bookmarks</span>
                            </a>
                        </li>
                        <li>
                            <a href="/notifications" class={$path == "/notifications" ? activeBg : ""}>
                                <span class="badge">
                        ...
                        {#if $loggedInUser && $loggedInUser.role >= 4}
                            <li>
                                <a href="/dev/featureflags" class={$path == '/dev/featureflags' ? activeBg : ""}>
                                    <span class="badge">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-feather"><path d="M20.24 12.24a6 6 0 0 0-8.49-8.49L5 10.5V19h8.5z"/><line x1="16" y1="8" x2="2" y2="22"/><line x1="17.5" y1="15" x2="9" y2="15"/></svg>
                                    </span>
                                    <span class="flex-auto">Feature Flags</span>
                                </a>
                            </li>
                        {/if}
                        ...
                        {/if}
                        <li>
                            <a href="/guidelines" class={$path == '/guidelines' ? activeBg : ""}>
                                <span class="badge">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-book"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"></path><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"></path></svg>
                                </span>
                                <span class="flex-auto">Guidelines</span>
                            </a>
                        </li>
